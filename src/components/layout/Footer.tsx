        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 flex items-center justify-center rounded-lg bg-white text-slate-500 hover:bg-humanic-green hover:text-white transition-all duration-300"
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.href}
                    className="text-slate-500 hover:text-neon-lime transition-colors duration-300 text-sm flex items-center gap-2 group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a 
                  ...
                  className="text-slate-500 hover:text-neon-lime transition-colors text-sm"
                >
                  {contactInfo.phone}
                </a>
              </li>
            ...
            <div className="mt-6 p-4 bg-white rounded-xl border border-slate-200">
              <p className="text-slate-400 text-xs mb-1">Horario de Atención</p>
              <p className="text-slate-700 text-sm">{contactInfo.hours}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="section-padding py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <Link 
                to="/politicas" 
                className="text-slate-400 hover:text-slate-500 text-sm transition-colors"
              >
